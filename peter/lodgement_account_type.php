...
UNION
(SELECT	accountholder.customerNumber, accountholder.accountType, depositaccount.accountNumber, 
    depositaccount.balance, depositaccount.closed
FROM
    depositaccount
...
UNION
(SELECT accountholder.customerNumber, accountholder.accountType, 
		loanaccount.accountNumber, loanaccount.balance, loanaccount.closed
FROM loanaccount
